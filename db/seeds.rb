...
Gig.create!(name: 'Bucket', description: 'Ed Eales-White and Jon Pointing slam down a new character/sketch/double-act comedy show.', artist_id: a2.id, venue_id: v2.id, tickets_available: 50, start_time: '2016-08-30 18:00:00', end_time: '2016-08-30 19:00:00')
Gig.create!(name: 'The Frantic Canticles of Little Brother Fish', description: 'Babolin welcome you to their monastery in deepest Depravia, where choristers chant and goose quills frantically scratch out the chronicle of an ancient quest.', artist_id: a3.id, venue_id: v3.id, tickets_available: 300, start_time: '2016-08-22 13:30:00', end_time: '2016-08-22 14:30:00')
Gig.create!(name: 'The Black Hoods Cabaret', description: 'Bear witness to the debauchery and murder of some of the most decrepit puppets to crawl out of a back alley. A puppet cabaret for adults that will charm you into darkness and mayhem, as a pair of calamitous puppeteers manipulate a variety of disturbed and troubled puppets.', artist_id: a4.id, venue_id: v4.id, tickets_available: 150, start_time: '2016-08-22 22:10:00', end_time: '2016-08-22 23:10:00')
Gig.create!(name: 'Mozart at Teatime', description: 'Different artists and programmes each concert. Tea/coffee shortbread afterwards included.', artist_id: a5.id, venue_id: v5.id, tickets_available: 100, start_time: '2016-08-19 16:00:00', end_time: '2016-08-19 17:00:00')
