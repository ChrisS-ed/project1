...
g1 = Gig.create!(name: 'Double Act', description: 'Lazy Susan stand side by side, sling on some wigs and take a few long shots at triumph. Watch as they make pacts, shake hands and get drunk on fiction. Character comedy that shoots straight from the hip: come get a slice of the zeal.', artist_id: a1.id, venue_id: v1.id, ticket_price: 10, tickets_available: 100, start_time: '2016-08-31 21:00:00', end_time: '2016-08-31 22:00:00', keywords: 'comedy duo, sketches')
g2 = Gig.create!(name: 'Bucket', description: 'Ed Eales-White and Jon Pointing slam down a new character/sketch/double-act comedy show.', artist_id: a2.id, venue_id: v2.id, ticket_price: 8, tickets_available: 50, start_time: '2016-08-31 20:30:00', end_time: '2016-08-31 21:30:00', keywords: 'comedy duo, sketches')
g3 = Gig.create!(name: 'The Frantic Canticles of Little Brother Fish', description: 'Babolin welcome you to their monastery in deepest Depravia, where choristers chant and goose quills frantically scratch out the chronicle of an ancient quest.', artist_id: a3.id, venue_id: v3.id, ticket_price: 15, tickets_available: 300, start_time: '2016-08-31 21:30:00', end_time: '2016-08-31 22:30:00', keywords: 'theatre, monks')
g4 = Gig.create!(name: 'The Black Hoods Cabaret', description: 'Bear witness to the debauchery and murder of some of the most decrepit puppets to crawl out of a back alley. A puppet cabaret for adults that will charm you into darkness and mayhem, as a pair of calamitous puppeteers manipulate a variety of disturbed and troubled puppets.', artist_id: a4.id, venue_id: v4.id, ticket_price: 9, tickets_available: 150, start_time: '2016-08-31 21:15:00', end_time: '2016-08-31 21:45:00', keywords: 'puppets, puppetry, cabaret')
g5 = Gig.create!(name: 'Mozart at Teatime', description: 'Different artists and programmes each concert. Tea/coffee shortbread afterwards included.', artist_id: a5.id, venue_id: v5.id, ticket_price: 6, tickets_available: 100, start_time: '2016-08-31 20:30:00', end_time: '2016-08-31 22:30:00', keywords: 'classical music')
g6 = Gig.create!(name: 'Bach for Breakfast', description: 'Different artists and programmes each concert. Tea/coffee and pastries afterwards included.', artist_id: a5.id, venue_id: v5.id, ticket_price: 6, tickets_available: 75, start_time: '2016-08-31 09:30:00', end_time: '2016-08-31 10:30:00', keywords: 'classical music')
